...
import { netlify, github } from "../assets";
import { SectionWrapper } from "../hoc";
import { projects } from "../constants";
import {fadeIn, textVariant } from '../utils/motion';

const ProjectCard = ({index, name, description, tags,
image, source_code_link, source_live_link}) => {
  return(
      ...
      sm:w-[360px] w-full'>
        <div className="relative w-full h-[230px]">
          ...
          justify-end m-3 card-img_hover">
            <div
            onClick={() => window.open (
              source_live_link, "blank")}
              className="black-gradient w-10 h-10 mr-2 rounded-full
  ...
  return (
    ...
    <div className="w-full flex">
      ...
      max-w-3xl leading-[30px]">
        ...
        demos in it. It reflect my ability to solve complex problems,
