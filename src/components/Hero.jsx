  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className="text-[#915eff]">Ruby</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I developed User Interfaces <br className="sm:block hidden"/> and Web Applications
          </p>
        </div>
      </div>  
